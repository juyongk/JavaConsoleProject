...
public class AccountManager implements MenuChoice, Serializable {
    ...
    public void loadAccountsFromFile() {
        ...
        if (file.exists()) {
            try {
                ...
                accounts = (HashSet<Account>) objectIn.readObject();
                objectIn.close();
                System.out.println("정보가 파일에서 로드되었습니다.");
            } catch (IOException | ClassNotFoundException e) {
                System.err.println("정보 불러오기 오류: " + e.getMessage());
            }
        } else {
            try {
                // 존재하지 않을 시 빈 파일을 생성한다.
                file.createNewFile();
                System.out.println("새로운 빈 파일이 생성되었습니다: " + FILE_NAME);
            } catch (IOException e) {
    ...
    public void saveAccountsToFile() {
        try {
            ...
            objectOut.close();
            System.out.println("정보가 " + FILE_NAME + "에 저장되었습니다.");
        } catch (IOException e) {
            System.err.println("정보 저장 오류: " + e.getMessage());
        }
    }
